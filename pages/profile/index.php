              ...
              <form method='POST' id='frm_profile' class="profile">
                <div class="row">
                  ...
                  <div class="form-group col-sm-6" style="padding: 5px;">
                    ...
                    <select class="form-control input-item" name="input[user_category]" id="user_category" style="pointer-events:none;" required>
                        <option value="">&mdash; Please Select &mdash;</option>
                        <option value="A">Admin</option>
                        <option value="B">Biker</option>
                    </select>
                  </div>
                  <div class="form-group col-sm-12" style="padding: 5px;">
                    <label for="exampleInputUsername1">Address</label>
                    <textarea autocomplete="off" class="form-control input-item" id="user_address" name="input[user_address]"></textarea>
                  </div>
                  <div class="form-group col-sm-12" style="padding: 5px;">
                  ...
                  <input type="hidden" autocomplete="off" value="<?= $_SESSION['user']['id'] ?>" name="input[user_id]" class="form-control" id="hidden_id">
                  <div class="form-group col-sm-12" style="padding: 5px;">
        ...
        <div class="card card-custom">
          <div class="card-body">
            ...
            <form method='POST' id='frm_password' class="password">
              ...
              <input type="hidden" autocomplete="off" value="<?= $_SESSION['user']['id'] ?>" name="input[user_id]" class="form-control" >
              <div class="form-group">
